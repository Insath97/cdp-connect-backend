...
class UpdateLegalRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'business_entered_date' => 'nullable|string|max:255',
            'completed_date' => 'nullable|string|max:255',
            'execution_year' => 'nullable|string|max:255',
            'amount_in_words' => 'nullable|string|max:255',
            'plan' => 'nullable|string|max:255',
            'monthly_profit' => 'nullable|string|max:255',
            'monthly_profit_day' => 'nullable|string|max:255',
            'month_6_breakdown_in_words' => 'nullable|string|max:255',
            'year_1_breakdown_in_words' => 'nullable|string|max:255',
            'year_2_breakdown_in_words' => 'nullable|string|max:255',
            'year_3_breakdown_in_words' => 'nullable|string|max:255',
            'year_4_breakdown_in_words' => 'nullable|string|max:255',
            'year_5_breakdown_in_words' => 'nullable|string|max:255',
